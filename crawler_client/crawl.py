...
utils/decorators.py::admin_required + blueprints/crawl.py). Gọi 3
endpoint backend: GET /sources, POST /crawl, GET /crawl/{run_id},
GET /crawl (lịch sử) — xem sql/migration_add_crawl_runs.sql phía
backend để biết đầy đủ thiết kế.
"""
...
def get_sources() -> dict:
    ...
    đây), khác hẳn 3 hàm bên dưới đều bắt buộc access_token thật.
